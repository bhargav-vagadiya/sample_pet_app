...
class ApiResponse {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ApiResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ApiResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ApiResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ApiResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
