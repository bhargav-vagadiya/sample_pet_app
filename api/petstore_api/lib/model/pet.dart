...
class Pet {
  ...
  @override
  String toString() =>
      'Pet[name=$name, photoUrls=$photoUrls, id=$id, category=$category, tags=$tags, status=$status]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Pet[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Pet[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Pet(
        ...
        photoUrls: json[r'photoUrls'] is Iterable
            ? (json[r'photoUrls'] as Iterable)
                .cast<String>()
                .toList(growable: false)
            : const [],
        id: mapValueOfType<int>(json, r'id'),
        category: Category.fromJson(json[r'category']),
        tags: Tag.listFromJson(json[r'tags'], growable: true),
  ...
  static Map<String, List<Pet>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Pet.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
class PetStatusEnum {
  ...
  static List<PetStatusEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class PetStatusEnumTypeTransformer {
  factory PetStatusEnumTypeTransformer() =>
      _instance ??= const PetStatusEnumTypeTransformer._();
