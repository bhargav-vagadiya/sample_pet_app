...
class UserApi {
  ...
  ///
  /// * [List<User>] user:
  Future<Response> createUsersWithListInputWithHttpInfo({
    List<User>? user,
  }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [List<User>] user:
  Future<User?> createUsersWithListInput({
    List<User>? user,
  }) async {
    final response = await createUsersWithListInputWithHttpInfo(
      user: user,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
  ...
  Future<Response> getUserByNameWithHttpInfo(
    String username,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/user/{username}'.replaceAll('{username}', username);
  ...
  Future<User?> getUserByName(
    ...
    final response = await getUserByNameWithHttpInfo(
      username,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
